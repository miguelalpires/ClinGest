...
//Class_Initialize Event @2-DE0438B7
...
//Show Page @1-3150FE0B
$Login->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", "<center><font f" . "ace=\"Arial\"><sma" . "ll>&#71;ener&" . "#97;ted <!-- SCC " . "-->&#119;&#1" . "05;&#116;h <" . "!-- SCC -->C&#11" . "1;&#100;eCh&" . "#97;rge <!-- SCC " . "-->&#83;&#11" . "6;&#117;dio." . "</small></font></center>" . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", "<center><font f" . "ace=\"Arial\"><sma" . "ll>&#71;ener&" . "#97;ted <!-- SCC " . "-->&#119;&#1" . "05;&#116;h <" . "!-- SCC -->C&#11" . "1;&#100;eCh&" . "#97;rge <!-- SCC " . "-->&#83;&#11" . "6;&#117;dio." . "</small></font></center>" . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= "<center><font f" . "ace=\"Arial\"><sma" . "ll>&#71;ener&" . "#97;ted <!-- SCC " . "-->&#119;&#1" . "05;&#116;h <" . "!-- SCC -->C&#11" . "1;&#100;eCh&" . "#97;rge <!-- SCC " . "-->&#83;&#11" . "6;&#117;dio." . "</small></font></center>";
}
