...
//Connection Settings @0-B87AAB6F
...
//Initialize Common Variables @0-9880C116
...
$CCSLocales->AddLocale("pt-PT", Array("pt", "PT", array(1, 0, ""), 2, ",", ".", array("Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"), array("Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"), array("domingo", "segunda-feira", "terça-feira", "quarta-feira", "quinta-feira", "sexta-feira", "sábado"), array("dom", "seg", "ter", "qua", "qui", "sex", "sáb"), array("D", "S", "T", "Q", "Q", "S", "S"), array("dd", "-", "mm", "-", "yyyy"), array("dddd", ", ", "d", " de ", "mmmm", " de ", "yyyy"), array("H", ":", "nn"), array("H", ":", "nn", ":", "ss"), "", "", 1, false, "", "windows-1252", "CP1252"));
$CCSLocales->DefaultLocale = strtolower("pt-PT");
$CCSLocales->Init();
...
//CCLoginUser @0-818BF71D
function CCLoginUser($login, $password)
{
    CCLogoutUser();
    $db = new clsDBConnection1();
    $SQL = "SELECT Id, Level, Password FROM acessos WHERE Login=" . $db->ToSQL($login, ccsText) . " AND Password=" . $db->ToSQL($password, ccsText);
    $db->query($SQL);
